        ...
        return (
            <div className="py-20 text-center bg-gray-50 min-h-screen">
                <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
                    ...
                    <button onClick={() => window.location.href = '/halo-dashboard'} className="mt-8 w-full bg-blue-600 text-white px-6 py-3 rounded-md font-semibold hover:bg-blue-700">{t('nav.dashboard') || 'Go to Dashboard'}</button>
                </div>
            </div>
        );
    }
            ...
            <TranslationProvider>
                <LogoProvider>
                    <AuthProvider>
                        ...
                        <Route
                            path="/dashboard"
                            element={<Navigate to="/halo-dashboard" replace />}
                        />
                        <Route
                            path="/halo-dashboard"
                            element={
