...
function BlogPage() {
    ...
    const noResultsMessage = useMemo(() => {
        if (currentSearch) {
            return t('blogpage.search.no_results', { keyword: currentSearch });
        } else if (currentCategory) {
            return t('blogpage.category.no_results');
        } else {
            return t('blogpage.initial.no_posts');
        }
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        <h1 className="text-4xl md:text-5xl font-bold mb-4">
                            {t('blogpage.header.title')}
                        </h1>
                        <p className="text-xl text-blue-100 max-w-2xl mx-auto">
                            {t('blogpostpage.header.description')}
                        </p>
                    </div>
            ...
            <section className="py-12 bg-gray-50" aria-label="Blog category filters">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-wrap gap-3 justify-center">
                        ...
                        >
                            {t('blogpage.all_posts_filter_label')}
                        </button>
                        {categoriesLoading ? (
            ...
            <section className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    {loading ? (
                        ...
                        <ErrorState
                            title={t('blogpage.error.title')}
                            message={t('blogpage.error.message')}
                            onRetry={fetchPosts}
                            retryLabel={t('blogpage.error.retry_button')}
                        />
                    ) : posts.length > 0 ? (
                        <>
                                    ...
                                    >
                                        ...
                                        <div className="p-6">
                                            ...
                                            <h2 className="text-xl font-semibold text-gray-900 mb-3 line-clamp-2">
                                                ...
                                                >
                                                    {getSafeTitle(post.title?.rendered || t('blogpage.post.untitled'))}
                                                </Link>
                                            </h2>
                        ...
                        <div className="text-center py-16">
                            ...
                            {currentSearch && (
                                ...
                                >
                                    {t('blogpage.no_posts.clear_search')}
                                </button>
                            )}
                        </div>
                    )}
