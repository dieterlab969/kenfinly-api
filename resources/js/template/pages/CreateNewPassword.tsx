						...
						<div className="verify-number-bottom-wrap">
							<div className="verify-number-content">
								...
								<div className="verify-txt mt-24">
									...
									<p>{t('Create Your New Password')}</p>
								</div>
								<form className="password-form">
									<div className="form-floating mt-24">
										...
										<label htmlFor="floatingInput">{t('New Password')}</label>
									...
									<div className="form-floating mt-12">
										...
										<label htmlFor="floatingPassword">{t('Re Enter New Password')}</label>
								...
								<div className="remember-section mt-16">
									<div className="footer-checkbox-sec">
										...
										<label htmlFor="footer-checkbox" className="footer-chec-txt">{t('Remember me')}</label>
									</div>
								</div>
								<div className="verify-number-btn"><Link to="/SignIn">{t('Continue')}</Link></div>
							</div>
						</div>
					</div>
				</div>
