...
import LineChartComponrnts from '../components/LineChartComponents.tsx';
                ...
                <div>
                        <div className="site-content">
                                <div className="verify-number-main">
                                        ...
                                        <div className="verify-number-bottom area-chat" id="send-money-contact">
