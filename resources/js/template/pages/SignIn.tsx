...
const SignIn: React.FC = () => {
  ...
  const handleGoogleSignIn = (): void => {
    ...
    // Full-page redirect to the Laravel OAuth redirect endpoint.
    // Laravel → Google → /api/v1/auth/google/callback → /auth/google/success
    window.location.href = '/api/v1/auth/google/redirect';
  };

  const displayError = error || (urlError ? 'Google sign-in failed. Please try again or use email.' : '');
